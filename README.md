...
### 🔹 Marco-3
Sistema de classificação de dígitos rodando em FPGA (DE1-SoC), integrando entrada de mouse, saída VGA e um coprocessador ELM para a inferência.
`C` `FPGA` `VGA` `Hardware/Software Co-design`

### 🔹 Marco-2
Driver em Assembly para comunicação MMIO entre o processador (HPS) e a FPGA, rodando sobre Linux embarcado.
`ARM Assembly` `Linux` `MMIO` `Device Drivers`
...
<p align="left">
  <img height="165" src="https://github-readme-stats.vercel.app/api?username=MarceloSC-dev&show_icons=true&theme=default&hide_border=true" />
  <img height="165" src="https://github-readme-stats.vercel.app/api/top-langs/?username=MarceloSC-dev&layout=compact&hide_border=true" />
</p>
